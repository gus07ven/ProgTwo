...
/**
 * This progra uses the RandomAccessFile class to open
 * the file Letters.day and randomly read letters from 
 * different locations.
 * @author Gustavo
 *
 */
...
public class ReadRandomLetters {
	...
	public static void main(String[] args) throws IOException {
		...
		final int CHAR_SIZE = 2;				// 2 byte character
		...
		// Move to the character 10 (the 11th character)
		...
		// Move to the character 3 (the 4th character)
		// read the character, and display it. 
